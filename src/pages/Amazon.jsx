...
import AmazonGlobalServiceCard from '../components/AmazonGlobalServiceCard';
...
export default function Amazon() {
  ...
  return (
      ...
      <section className="py-16 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8">
          ...
          <p className="mt-3 text-slate-300 text-sm sm:text-base leading-relaxed">
            Transparent breakdown of official referral commissions and closing fees across Amazon India domestic and Amazon US Global marketplaces.
          </p>
        </div>

        {/* Rate Cards Marketplace Option Toggle */}
        <div className="flex justify-center mb-12">
          <div className="inline-flex p-1.5 rounded-2xl bg-slate-900 border border-white/10 shadow-2xl backdrop-blur-xl">
            <button
              ...
              className={`btn-pressable px-5 sm:px-7 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all flex items-center gap-2 ${
                amazonScope === 'india'
            ...
            >
              ...
              <span>Amazon India (234 Categories)</span>
            </button>
            <button
              type="button"
            ...
            >
              <span className="text-base sm:text-lg">🌐</span>
              <span>Amazon US Global (37 Categories)</span>
            </button>
          </div>
        </div>

        {/* --- VIEW 1: AMAZON INDIA RATE CARDS & TABLES --- */}
        {amazonScope === 'india' && (
    ...
    {/* --- VIEW 2: AMAZON US GLOBAL RATES (37 CATEGORIES + USD CALCULATOR) --- */}
    {amazonScope === 'global' && (
      <div className="space-y-10 animate-fade-scale">
  ...
  {/* =========================================================================
      MONTHLY BILLING / MANAGEMENT PLANS (Toggled by Scope)
      ========================================================================= */}
  <section className="py-12 max-w-6xl mx-auto px-4 sm:px-6">
        {/* In-Place Plans Scope Toggle */}
        <div className="flex justify-center mb-8">
          <div className="inline-flex p-1.5 rounded-2xl bg-slate-900 border border-white/10 shadow-2xl backdrop-blur-xl">
            <button
              type="button"
              onClick={() => setAmazonScope('india')}
              className={`btn-pressable px-6 sm:px-8 py-2.5 rounded-xl text-xs sm:text-sm font-bold transition-all flex items-center gap-2 ${
                amazonScope === 'india'
                  ? 'bg-blue-600 text-white shadow-lg shadow-blue-600/30'
                  : 'text-slate-400 hover:text-white hover:bg-white/5'
              }`}
            ...
            >
              <span className="text-base sm:text-lg">🌐</span>
              <span>amazon Global Service</span>
            </button>
          </div>
        </div>
        ...
        {amazonScope === 'india' ? (
          ...
          <div className="animate-fade-scale pt-2">
            <AmazonGlobalServiceCard />
          </div>
        )}
      </section>
    </div>
