        ...
        <div className="text-center max-w-3xl mx-auto mb-10">
          ...
          <div className="mt-8 flex items-center justify-center gap-3">
            <button
              ...
              className={`px-6 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2 ${activeGlobalTab === 'amazon'
            ...
            <button
              ...
              className={`px-6 py-2.5 rounded-xl text-xs font-bold transition-all flex items-center gap-2 ${activeGlobalTab === 'ebay'
                  ? 'bg-cyan-500 text-slate-950 shadow-lg shadow-cyan-500/25'
                  : 'bg-white/5 text-slate-300 hover:text-white border border-white/10'
                }`}
            >
